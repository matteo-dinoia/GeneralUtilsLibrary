...
public class Camera3D {
	...
	private Vector2D getScreenFromLocalCoord(Vector3D localCoord){
		...
		/*ris.rotateAxisX(-lookingDirection.getAngleX());
		ris.rotateAxisY(-lookingDirection.getAngleY());
		ris.rotateAxisZ(-lookingDirection.getAngleZ());*/
		double hAngle=ris.getAngleY();
		double vAngle=ris.getAngleZ();
		hAngle-=lookingDirection.getAngleY();
		vAngle-=lookingDirection.getAngleZ();
